...
import com.rbkmoney.cashreg.service.kafka.serde.SinkEventDeserializer;
...
public class KafkaConfiguration {
    ...
    private static final String GROUP_ID = "CashRegListener155";
    ...
    @Bean
    public KafkaListenerContainerFactory<ConcurrentMessageListenerContainer<String, SinkEvent>> kafkaListenerContainerFactory(
