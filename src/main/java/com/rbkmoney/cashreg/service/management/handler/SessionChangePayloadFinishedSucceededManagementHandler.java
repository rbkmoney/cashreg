...
public class SessionChangePayloadFinishedSucceededManagementHandler extends AbstractManagementHandler {
    ...
    public SessionChangePayloadFinishedSucceededManagementHandler(ManagementType managementType) {
        super(managementType.getSessionPayloadFinishedResultSucceeded());
    }
